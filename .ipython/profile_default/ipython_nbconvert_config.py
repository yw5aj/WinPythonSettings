...
# a config file.
# 
# - markdown2rst - escape_latex - filter_data_type - ipython2python - strip_ansi
# - path2url - get_lines - posix_path - markdown2html - add_prompts - wrap_text
# - highlight2html - add_anchor - comment_lines - ansi2latex - indent -
# citation2latex - markdown2latex - html2text - strip_files_prefix - ascii_only
# - strip_dollars - highlight2latex - ansi2html
